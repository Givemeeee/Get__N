...
get3Newyear,get3Newmonth= get_three_month()
#儲存資料創建空串列
month_one_ago = []
month_two_ago = []
month_three_ago = []
...
month_three_ago.append(stock.fetch(get3Newyear,get3Newmonth))
print(month_one_ago)
...
output_path = r'C:\Users\s1010\Documents\python\sTock\stock_data3m.csv'
...
with open(output_path,'w',newline='',encoding='utf-8') as f:
    ...
    for stock_data in month_three_ago[0]:
        writer.writerow([
            str(stock_data.date),
            stock_data.open,
            stock_data.high,
